    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                String executablePath = directoyPath + "\\Trudograd_Win64.exe";
                ...
                String atomRpgDataPath = Path.GetFullPath(directoyPath + "\\Trudograd_Win64_Data");
        ...
        {
            String dllPath = Path.GetFullPath("Trudograd.DebuggerInjection.dll");
